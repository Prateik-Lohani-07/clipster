...
2. **Seamless Copy**: You can click on the text box as many times as you want to copy the text.

3. **Drag n' Drop**: Save your top priority clips for easy access.

4. **Color Coding**: Clipster provides color coding with upto 6 different colors so you can copy text faster visually.
